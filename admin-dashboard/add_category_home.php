                                        ...
                                        <table id="zero-conf" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<tr><td>{$i}</td><td>{$row['category_name']}</td><td>{$row['category_slug']}</td>
                                                    <td>
                                                <a href= \"edit_category.php?id={$row['category_id']}\"   data-toggle= \"tooltip \" data-original-title= \"Edit \"> <i class= \"fas fa-pencil-alt \" style=\"color:#7d7d83\"></i></a>
                                                <button type=\"button\" id=\"delete\" onClick=\"del('{$row['category_id']}')\" class=\"far fa-trash-alt  \" style=\"border: none;background-color: transparent;color:#7d7d83\"></button>
