                ...
                <div class="page-content">
                    <div class="page-info">
                        ...
                        <div class="page-options">
                            <a href="add_subcategory" class="btn btn-primary">Add a New Sub Category</a>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body table-responsive">
                                        ...
                                        <table id="zero-conf" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $result = mysqli_query($link, "SELECT * FROM `articles_sub_category`");
                                                $i = 1;
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<tr><td>{$i}</td><td>{$row['sub_category_name']}</td><td>{$row['category_name']}</td><td>{$row['sub_category_slug']}</td>
                                                    <td>
                                                <a href= \"edit_subcategory.php?id={$row['sub_category_id']}\"   data-toggle= \"tooltip \" data-original-title= \"Edit \"> <i class= \"fas fa-pencil-alt \" style=\"color:#7d7d83\"></i></a>
                                                <button type=\"button\" id=\"delete\" onClick=\"del('{$row['sub_category_id']}')\" class=\"far fa-trash-alt  \" style=\"border: none;background-color: transparent;color:#7d7d83\"></button>
