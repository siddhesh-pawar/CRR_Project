            ...
            <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="main-wrapper d-flex justify-content-center col-12">
                        ...
                        <div class="row">
                            <div class="card">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4">Add a Author</h2>
                                <div class="card-body pt-3">
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-lg-12">
                                            <div class="form-group" id="title">
                                                ...
                                                <input type="text" id="author" class="form-control" required="" placeholder="Add the author name" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text " id="author_descrip" class="form-control " required="" placeholder="Add the author description" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                    ...
                                    <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="add-author" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Add Author</button>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#add-author').on('click', function(e) {
                    ...
                    if ($('#hero-image').val() == "") {
                        sweetAlert("Warning", "Please enter Profile Picture", "warning");
