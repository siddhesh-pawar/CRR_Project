                ...
                <div class="page-content">
                    <div class="page-info">
                        ...
                        <div class="page-options">
                            <a href="add_comments" class="btn btn-primary">Add a New Comment</a>
                        </div>
                    </div>
                                        ...
                                        <table id="zero-conf" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<input type=\"hidden\" id=\"comment_id\" value=\"{$row['comment_id']}\">";


                                                    echo "<tr><td>{$i}</td><td>{$row['name']}</td><td>{$row['email']}</td><td>{$row['comment']}</td>
                                                    <td>
                                                 
                                                <a href= \"edit_sub_comment_home.php?id={$row['comment_id']}\"   data-toggle= \"tooltip \" data-original-title= \"Add\"><i class=\"fas fa-eye mr-2\"  style=\"color:#7d7d83\"></i></a>
