...
if (isset($_POST['comment_id']) && $_POST['response']) {
    session_start();
    ...
    if ($responseData->success) {
        ...
        $sub_comment_id = guidv4(openssl_random_pseudo_bytes(16));
        ...
        $query = "INSERT INTO `sub_comment`(`sub_comment_id`,`user_name`,`user_email`,`comment_id`,`sub_comment`,`article_id`,`from_ip`,`from_browser`,`time`) VALUES('$sub_comment_id','$name','$email','$comment_id','$sub_comment','$article_id','$from_ip','$from_browser','$date_now')";
