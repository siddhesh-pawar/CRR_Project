...
if (isset($_POST['category_name'])) {
    ...
    // This function will return a random 
        ...
        // Random string of length 10 
                ...
                $query = "INSERT INTO `articles_category`(`category_id`, `category_name`, `category_slug`, `from_ip`, `from_browser`, `created_at`) VALUES ('$category_id','$category_name','$category_slug','$from_ip','$from_browser','$date_now')";
