    ...
    <body>
                    ...
                    <ul class="accordion-menu">
                        ...
                        <li class="active-page">
                            ...
                            <ul class="sub-menu" style="display: none;">
                                ...
                                <li>
                                    <a href="title" class="active">Title and Description </a>
                                </li>
                                <li>
            ...
            <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="main-wrapper d-flex justify-content-center col-12">
                        ...
                        <div class="row">
                            <div class="card">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4 pl-4">Edit Title and Description</h2>
                                <div class="card-body pt-3">

                                    <div class="row pt-3">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="control-label" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Title</label>
                                                <input type="text" id="title" class="form-control" required="" value="<?php echo $row['title']; ?>" placeholder="Add Title for website" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                                <input type="hidden" id="title_id" class="form-control" required="" value="<?php echo $row['id']; ?>">
        ...
        <script>
            $(document).ready(function() {
                ...
                //     var author_descript = $('#author_des').val();
