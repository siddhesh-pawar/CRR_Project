                                ...
                                <div class="card-body pt-3">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="bg-light col-12 p-3">
                                            ...
                                            ?>
                                            <input type="hidden" id="logo_id" value="<?php echo ($row['id']); ?>">
                                            <input type="hidden" id="old_image" value="<?php echo ($row['logo_image']); ?>">
                                            <input type="file" id="hero-image" class="dropify" data-default-file="<?php echo "assets/images/uploads/logo/" . $row['logo_image'] ?>" />
                                    ...
                                    <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="edit-logo" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Edit Logo</button>
            ...
            $(document).ready(function() {
                ...
                $('#edit-logo').on('click', function(e) {
                    ...
                    if (error == "") {
                        ...
                        formData.append('logo_id', $('#logo_id').val());
