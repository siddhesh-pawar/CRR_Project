...
$id = $_REQUEST['id'];
$query = "SELECT * from sub_comment where sub_comment_id ='" . $id . "'";
    ...
    <body>
            ...
            <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="main-wrapper d-flex justify-content-center">
                        ...
                        <div class="row">
                            <div class="card p-5">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4">Edit a Sub Comment</h2>
                                <div class="card-body pt-3">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="sub_comment_id" class="form-control" value="<?php echo ($row['sub_comment_id']); ?>">

                                                <input type="text " id="sub_comment" class="form-control " required="" placeholder="Add the sub comment" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px" value="<?php echo ($row['sub_comment']); ?>">
                                        ...
                                        <!-- <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text " id="name" class="form-control " required=""  placeholder="Enter Name" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px" value="<?php echo ($row['user_name']); ?>">

                                                <label class="control-label mt-2" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Email</label>

                                                <input type="text " id="email" class="form-control " required=""  placeholder="Enter Email" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px" value="<?php echo ($row['user_email']); ?>">
                                    ...
                                    <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="edit-sub-comment" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Edit Sub comment</button>
        ...
        <script>
            ...
            $('#edit-sub-comment').on('click', function(e) {
                ...
                if (error == "") {
                    formData.append('sub_comment_id', $('#sub_comment_id').val());




                    $.ajax({
                        url: "PHP/editSubComment.php",
                        type: "POST",
                        dataType: "json",
                        cache: false,
                        contentType: false,
