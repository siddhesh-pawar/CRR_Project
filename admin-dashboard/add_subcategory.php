    ...
    <body>
            ...
            <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="main-wrapper d-flex justify-content-center">
                        ...
                        <div class="row">
                            <div class="card">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4">Add a Sub category</h2>
                                <div class="card-body pt-3">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text " id="sub_category_name" class="form-control " required="" placeholder="Add the sub category name" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text " id="sub_category_slug" class="form-control " required="" placeholder="Add the category_slug " style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px" readonly>
                                    ...
                                    <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="add-sub-category" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Add Sub Category</button>
        ...
        <script>
            ...
            $('#add-sub-category').on('click', function(e) {
                ...
                if ($('#category select').val() == "select") {
                    sweetAlert("Warning", "Please enter a valid category", "warning");
