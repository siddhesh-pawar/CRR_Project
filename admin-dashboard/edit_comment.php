            ...
            <div class="page-header">
                ...
                <div class="page-content">
                    ...
                    <div class="main-wrapper d-flex justify-content-center">
                        ...
                        <div class="row">
                            <div class="card">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4">Edit a comment</h2>
                                <div class="card-body pt-3">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <?php
                                           ...
                                           $result1 = mysqli_query($link, "SELECT * FROM `articles` WHERE `article_id` = '$article_id'" );
                                        ...
                                        <div class="form-group" id="article">
                                                        <label class="control-label"  style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Select Article</label>
                                                        <select class="form-control custom-select" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px"  data-placeholder="Choose a Category" tabindex="1" >
                                                            <option value="<?php echo($row1['article_id']);?>"><?php echo($row1['title']);?></option>
                                                        </select>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input type="hidden" id="comment_id" class="form-control"  placeholder="Add the Name" value="<?php echo($row['comment_id']);?>" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                                <label class="control-label" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Name</label>

                                                <input type="text " id="name" class="form-control" required=""  placeholder="Add the Name" value="<?php echo($row['name']);?>" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">

                                                <label class="control-label" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Email</label> 

                                                <input type="text " id="email" class="form-control" required=""  placeholder="Add the email" value="<?php echo($row['email']);?>" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">

                                                <label class="control-label" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Comment</label>

                                                <textarea id="comment" class="form-control" rows="5"  style="padding: 12px 18px;border-radius: 7px;"><?php echo($row['comment']);?></textarea>
                                    ...
                                    <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="edit-comment" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Edit Comment</button>
                            ...
                            success:function(data){
                                if(data.status == 201){
                                    ...
                                    for (var i=0; i<article_list.length ; i++){
                                        $("#article select").html( $("#article select").html() + '<option value="'+article_list[i]['article_id']+'">'+ article_list[i]['title'] +' </option>');
                                    }
