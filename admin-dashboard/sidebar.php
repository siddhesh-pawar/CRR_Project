                    ...
                    <ul class="accordion-menu">
                        ...
                        <li class="active-page">
                            ...
                            <ul class="sub-menu" style="display: none;">
                                ...
                                <li>
                                    <a href="sidebar" class="active">Side Bar </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="main-wrapper d-flex justify-content-center col-12">
                        ...
                        <div class="row">
                            <div class="card">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4">Edit Sidebar Images</h2>
                                <div class="card-body pt-3">
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="bg-light col-12 p-3">
                                            ...
                                            ?>
                                            <!-- <input type="hidden" id="image_id" value="<?php echo ($row['id']); ?>"> -->
                                            <input type="file" id='files' name="files[]" multiple><br>
                                            <input type="button" id="submit" value='Upload' class="btn btn-md mt-4" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">
                                    ...
                                    <!-- <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="add-image" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Edit Logo</button>

                                    </div> -->
                                    <div id="preview p-4">
                                        <h3 class="text-center mt-4 mb-4">Images in the sidebar</h3>
                                        <div class="row">
                                            <?php
                                            $result = mysqli_query($link, "SELECT * FROM `sidebar`");
                                            ...
                                            ?>
                                                ...
                                                <div class="col-lg-6 p-3">
                                                    <div class="d-flex justify-content-center">
                                                        <img src="assets/images/uploads/sidebar/<?php echo ($row['image']); ?>" style="width:100%;" class="d-flex justify-content-center">
                                                    </div>


                                                    <button type="button" class="btn btn-danger mt-3" onclick="del('<?php echo ($image_id); ?>')">Delete</button>
                                                </div>
