    ...
    <body>
                    ...
                    <ul class="accordion-menu">
                        ...
                        <li class="active-page">
                            ...
                            <ul class="sub-menu" style="display: none;">
                                ...
                                <li>
                                    <a href="settings" class="active">Nav menu</a>
                                </li>
                                <li>
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="row ">
                            <div class="card col-lg-12">
                                <h2 class="d-flex justify-content-center  mb-0 pb-0 pt-4">User Settings</h2>
                                <div class="card-body pt-3">
                                    ...
                                    <div class="btn-group card-body p-0 pl-3 mt-4">
                                        <button class="btn" id="add-link" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Add link</button>
                                        <button class="btn ml-2" id="delete-link" type="button" style="font-size: 1rem;background-color: #f05154;color: #ffffff;">Delete link</button>
                                    </div>
                                    ...
                                    <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="add-settings" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Add Settings</button>
        ...
        <script>
            ...
            $('#add-link').on('click', function(e) {
                ...
                $("#delete-link").show();
                $("#header-link").append(
                    '<div class="header-link-next"><label class="control-label mt-2" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Nav bar name</label><input type="text " name="nav-name" class="form-control " required="" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px"><label class="control-label mt-2" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Nav bar link</label><input type="text " name="nav-link" class="form-control " required="" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px"></div>'
                );
