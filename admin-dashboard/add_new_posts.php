...
?>
    ...
    <body>
                ...
                <div class="page-content" style="overflow: initial;">
                    <div class="page-info" style="overflow: initial;">
                        ...
                        <div class="page-options d-flex justify-content-center" style="margin-right: 50px;">
                            <a href="add_new_posts" class="btn btn-primary mr-0" type="button" id="dropdownMenuButton22" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">
                                Add new posts
                            </a>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="add_new_posts">Add new posts</a>
                                    <div class="dropdown-divider"></div>
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                <div id="title" class="mb-4">
                                    ...
                                    <input class="form-control" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px" type="text" placeholder="Enter Title">
                                        ...
                                        <div class="tab-content mt-2">
                                            <div class="tab-pane fade show active" id="content">
                                                ...
                                                <div class="mt-4 p-3">
                                                    ...
                                                    <input type="file" id="hero-image" class="dropify" />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-11" id="hero-image-alt">
                                                            ...
                                                            <input type="text" class="form-control" id="caption" style="border-radius: 7px;padding: 8px 4px; width: 100%;">
                                            ...
                                            <div class="tab-pane fade" id="seo">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="slug" class="form-control" onchange="slugListner(this.value)" style="padding: 12px 18px;border-radius: 7px;">
                                                    <small class="form-control-feedback"><?php echo $baseurl; ?>blog/category/sub-category/this-is-my-first-blog</small>

                                                </div>
                                                <div class="form-group" id="excerpt">
                                                    <label>Blog Excerpt</label>
                                                    <textarea class="form-control" rows="5" style="padding: 12px 18px;border-radius: 7px;"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <p style="font-weight:bold;font-size:1.2rem;color:#717BA2;">Meta Tags</p>
                                                    <input name="tags" placeholder="Enter Tags" class="form-control" style="padding: 12px 18px;border-radius: 7px;">

                                                    <p style="font-weight:bold;font-size:1.2rem;color:#717BA2;">Meta Title</p>
                                                    <input type="text" class="form-control" placeholder="Enter Title" style="padding: 12px 18px;border-radius: 7px;" id="meta_title">

                                                    <!-- <p style="font-weight:bold;font-size:1.2rem;color:#717BA2;">Meta url</p>
                                                    <input type="text" class="form-control"  placeholder="Enter url" style="padding: 12px 18px;border-radius: 7px;" id="meta_url"> -->

                                                    <p style="font-weight:bold;font-size:1.2rem;color:#717BA2;">Meta description</p>
                                                    <input type="text" class="form-control" placeholder="Enter description" style="padding: 12px 18px;border-radius: 7px;" id="meta_description">

                                                    <!-- <p style="font-weight:bold;font-size:1.2rem;color:#717BA2;">Meta Image</p>
                                                    <input type="file" id="hero-image1"  class="dropify" /> -->
                                                </div>
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="pr-2" style="width: 100%;">
                                        ...
                                        <select class="form-control" style="border-radius: 7px;padding: 14px 4px;" id="author">
                                            <option class="abcd form-control" value="select">Select an Author</option>
                                    ...
                                    <div class="col-12 p-0 mt-3 ">
                                        ...
                                        <div class="form-check pl-4">
                                            <input class="form-check-input" type="radio" name="time" id="flexRadioDefault2" value="manual">
                                        ...
                                        <div id="calendarDiv" class="row mt-3">
                                            ...
                                            <div class="mydatepicker pl-3 col-12" id="date-of-posting">
                                                ...
                                                <input type="text" class="form-control" placeholder="2017-06-04" id="mdate" style="border-radius: 7px;padding: 12px 10px;">

                                            </div>
                                            <div class="mydatepicker pl-3 col-12" id="time-of-posting">
                                                <label>Time Of Posting</label>
                                                <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                                    <input type="text" class="form-control" placeholder="13:14" style="border-radius: 7px;padding: 12px 10px;">
                        ...
                        <div class="btn-group pt-2" id="button-stack">
                            <button class="btn ml-2" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;" id="add-blog">Publish</button>
        ...
        <script>
            ...
            // Slug change according to the title function
            ...
            $("#title input").keyup(function() {
                ...
                url = '<?php echo $baseurl; ?>read/' + category + '/' + sub_category + '/' + slug;
                    ...
                    success: function(data) {
                        if (data.status == 201) {
                            ...
                            for (var i = 0; i < category_list.length; i++) {
                                ...
                                $("#category").html($("#category").html() + '<li data-filter-item data-filter-name="' + category_list[i]['category_name'].toLowerCase() + '" style="list-style-type: none;font-weight:bold" class="' + class_name + ' ' + category_list[i]['category_name'].toLowerCase() + '" ><input type="checkbox" style="height: 16px;width: 16px;" id="' + category_list[i]['category_id'] + '"  name="category" value="' + '<?php echo $baseurl; ?>read-cat/' + category_list[i]['category_slug'] + '">' + '<p style="display:inline-block;padding-left: 5px;font-weight:bold;color:#717BA2;";>' + category_list[i]['category_name'] + '</p>');
            ...
            // Comment switch for enabling and disabling comments

            var comment_value = true;
            ...
            // Date and time input based on the value of switch
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#add-blog').on('click', function(e) {
                    ...
                    if ($('#hero-image').val() == "") {
                        error = error + 'hero-image';
                        sweetAlert("Warning", "Please upload a feature image for the blog", "warning");
                    } else {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data.status == 201) {
                                    ...
                                    window.location.replace("edit_article.php?id=" + article_id);
                                    console.log("success");
