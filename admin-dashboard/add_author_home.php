                                        ...
                                        <table id="zero-conf" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<input type=\"hidden\" id=\"author_id\" value=\"{$row['author_id']}\">";


                                                        echo "<tr><td>{$i}</td><td>{$row['author_name']}</td><td>{$row['author_description']}</td>
                                                        <td>
                                                        <a href= \"edit_author.php?id={$row['author_id']}\"   data-toggle= \"tooltip \" data-original-title= \"Edit \"> <i class= \"fas fa-pencil-alt \" style=\"color:#7d7d83\"></i></a>
                                                        <button type=\"button\" id=\"delete\" onClick=\"del('{$row['author_id']}')\" class=\"far fa-trash-alt  \" style=\"border: none;background-color: transparent;color:#7d7d83\"></button>
