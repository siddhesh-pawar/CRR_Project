    ...
    <body>
                ...
                <div class="page-content" style="overflow: initial;">
                    <div class="page-info" style="overflow: initial;">
                        ...
                        <div class="page-options d-flex justify-content-center" style="margin-right: 50px;">
                            <a href="add_entries" class="btn btn-primary mr-0" type="button" id="dropdownMenuButton22" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">
                                Add new entries
                            </a>
                            <!-- <div class="dropdown">
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#zero-conf').DataTable();
                // $(".page-sidebar").load('../template/sidebar.html');
