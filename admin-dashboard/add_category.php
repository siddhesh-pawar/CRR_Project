                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text " id="category_slug" class="form-control " required="" placeholder="Add the category_slug " style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px" readonly>
